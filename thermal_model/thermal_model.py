...
class ThermalModel:
    def __init__(self, w_max, r_th, x_th, y_th, V_e, kx, ky, core_center_random_noise_std):
    ...
    def core_center_at_height(self, h):
        ...
        eta_x = np.random.normal(self.core_center_random_noise_mean, self.core_center_random_noise_std)
        eta_y = np.random.normal(self.core_center_random_noise_mean, self.core_center_random_noise_std)
