...
class ThermalEstimator:
    def __init__(self, num_samples_to_buffer, debug=False):
        ...
        self.estimated_params = [
            ...
            0.0,
            0.0,
        ]  # Initial guess: [W0, Rth, x_th, y_th]
    ...
    def step(self, measurement, location):
        ...
        if result.success:
            ...
            if self.debug:
                print(
                    f"Estimated Parameters: W0={self.estimated_params[0]:.2f}, Rth={self.estimated_params[1]:.2f}, x_th={self.estimated_params[2]:.2f}, y_th={self.estimated_params[3]:.2f}"
                )
        else:
    ...
    def eval_thermal_updraft_with_estimated_params(self, radius_to_center):
        ...
        return self.thermal_model_estimate_updraft(
            eval_coordinate, core, self.estimated_params[0], self.estimated_params[1]
        )
